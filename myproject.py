...
class TestPostman(unittest.TestCase):
  ...
  def test1_post_create_user(self):
    payload = json.dumps({'id': user_id, 'username': user_name, 'firstName': first_name, 'lastName': last_name, 
                'email': email, 'password': password, 'phone': phone_number, 'userStatus': userStatus})
  ...
  def test4_put_update_user(self):
    payload = json.dumps({'id': user_id, 'username': user_name, 'firstName': update_first_name, 'lastName': update_last_name, 
                'email': email, 'password': password, 'phone': phone_number, 'userStatus': userStatus} )  
